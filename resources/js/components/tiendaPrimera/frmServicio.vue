                            ...
                            <form class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-6">
                                        ...
                                        &nbsp;&nbsp;&nbsp;
                                        <button type="button" class="btn btn-info text-white position-relative" data-bs-toggle="modal" data-bs-target="#modalPersonal" @click="listarPersonal(buscarP)"><i class="fa fa-search"></i> Agregar Personal</button>
                                    </div>
                                </div>
                                ...
                                &nbsp;
                                <template v-if="datos.id_cliente==0">
                                 <div class="col-md-12">
                                    <label>Productos<span style="color:red;" >(*Seleccione)</span></label>
                                    <button type="button" disabled class="btn btn-info text-white position-relative" data-bs-toggle="modal" data-bs-target="#modalArticulo2" @click="listarArticulo(buscarP, criterioP), listarArticulo2(buscarP, criterioP)"><i class="fa fa-search"></i> Agregar Productos/Servicios</button>
                                </div> 
                                </template>
                                <template v-else>
                                 <div class="col-md-12">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody v-else>
                                        <tr>
                                            <td colspan="6">No hay Servicios agregados</td>
                                        </tr>
                                    </tbody>
                                </table>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        &nbsp;&nbsp;<div class="input-group">
                                            ...
                                            <input type="text" v-model="buscarP" @keyup.enter="listarArticulo2(buscarP, criterioP)" @keyup="BuscandoProductoServicio()" class="form-control" placeholder="Texto a buscar">
                                            &nbsp;&nbsp;&nbsp;
            ...
            guardarServicio(){
                ...
                if(this.arrayDetalle.find(seg => ( seg.tipo_producto == 'Producto Venta' ? seg.stock - seg.cantidad < 0 : ''))){
                    ...
                    if(this.datos.total < 0){
                        ...
                        let me = this;
                        axios.post('/servicio/guardar_tienda1',{
