            ...
            <div class="row">
                ...
                <div class="card">
                   <div class="card-header text-center text-white" style="background-color: #3399FF">
                        <h3 class="mb-0">PAGOS DE VENTAS</h3>
                    </div>
                    <br>
                    ...
                    <table class="table table-striped table-hover" style='width:96%;margin-left: 2.2%'>
                        ...
                        <tbody>
                            <tr v-for="cliente in arrayCliente" :key="cliente.id">
                                    ...
                                    <td v-text="cliente.saldo_cliente"></td>
            ...
            <div class="modal-dialog modal-dialog-centered modal-fullscreen" role="document">
                <div class="modal-content">
                    <div class="modal-header btn btn-info text-white">
                        <h4 class="modal-title ">Pago de Venta al Crédito</h4>
        ...
        methods : {
            ...
            cargarDetalle(){
                ...
                axios.get(url).then(function(response){
                    ...
                    me.arrayDetalleCliente = me.arrayDetalleCliente.filter(item=>item.saldo > 0)
                })
                .catch(function(error){
                    console.log(error);
                });
