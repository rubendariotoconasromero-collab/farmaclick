...
<script>
    ...
    export default {
        ...
        created() {
            this.datos.id_paciente=this.selectMascota.id_paciente;
            this.datos.paciente=this.selectMascota.paciente;
            this.datos.propietario=this.selectMascota.propietario;
            this.datos.id_cliente=this.selectMascota.id_cliente;
            this.datos.color=this.selectMascota.color;
            this.datos.edad=this.selectMascota.edad;
            this.datos.raza=this.selectMascota.raza;
            this.datos.telefono=this.selectMascota.telefono;
            this.datos.direccion=this.selectMascota.direccion;
            this.datos.id_animal=this.selectMascota.id_animal;
            this.datos.especie=this.selectMascota.especie;
            this.datos.id=this.selectMascota.id_historial_clinico;
        ...
        methods : {
            ...
            volverVentaMenu(){
                this.listado = 1;
                this.$emit('cerrarVentaTienda', this.listadoVenta,this.datos.id);
            ...
            Nro_historia(){
                let me=this;
                var url='/nro_historia?id_cliente=' + me.selectMascota.id_cliente + '&id_paciente=' + me.selectMascota.id_paciente;
                axios.get(url).then(function(response){
                    //me.arrayPaciente=response.data;
