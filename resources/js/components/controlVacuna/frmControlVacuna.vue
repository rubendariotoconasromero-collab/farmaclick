    ...
    <main class="main">
        <!-- <div class="container"> -->
            <div class="row">
                ...
                &nbsp;
                    <div class="card">
                    <div class="card-header text-center text-white" style="background-color: #3399FF"><h3 class="mb-0">CONTROL VACUNA</h3></div>
                       <!-- Listado de Ventas -->
                            ...
                            <div class="card-body">
                                ...
                                <form class="row">
                                    ...
                                    <!-- <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control"  v-model="datos.mes" disabled>  
                                    </div> -->
                                    <div class="col-md-6">
                                    </div>&nbsp;
