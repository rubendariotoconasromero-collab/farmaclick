            ...
            <div class="row">
                ...
                <div class="card">
                   <div class="card-header text-center text-white" style="background-color: #3399FF">
                        <h3 class="mb-0">PRESENTACIÓN</h3>
                    </div>

                    <!-- prueba card -->
                    <div class="row mt-2" style='width:90%;margin-left: 1.3%'>
                    <div class="col-sm-6 col-lg-3">
                        <div class="card mb-4" style="--cui-card-cap-bg: #2F00E7">
                    ...
                    <div class="card-header">
                        <button type="button" @click="abrirModal('unidad_medida','registrar')" class="btn btn-info text-white" style='margin-left: 1%'>
                    ...
                    <div class="form-group row">
                        <div class="col-md-8">
                            &nbsp;&nbsp;<div class="input-group" style='width:96%;margin-left: 3.3%'>
                                ...
                                &nbsp;&nbsp;&nbsp;
                                <input type="text" v-model="buscar" @keyup.enter="listarUnidad(1, buscar, criterio)"  @keyup="BuscandoCategoria()" class="form-control" placeholder="Texto a buscar">
                                &nbsp;&nbsp;&nbsp;
                                <button type="submit" @click="listarUnidad(1, buscar, criterio)" class="btn btn-info text-white"><i class="fa fa-search"></i> Buscar</button>
                            </div>
                        </div>
                    </div>
                    <br>
                    ...
                    <table class="table table-striped table-hover" style='width:96%;margin-left: 2.2%'>
                        <thead style="background-color: #46546C">
                            <tr>                      
                                <th scope="col" class="text-white">Abreviatura</th>
                        ...
                        <tbody>
                            <tr v-for="unidad in arrayUnidad" :key="unidad.id">
                                ...
                                <td v-text="unidad.abreviatura"></td>      
                                <td>
                                ...
                                <td>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li><a class="dropdown-item" href="#" @click="abrirModal('unidad_medida','modificar',unidad)"><i class="fa fa-edit text-warning"></i> Modificar</a></li>
                                        <template v-if="unidad.estado==1">
                                            <li><a class="dropdown-item" href="#" @click="desactivarUnidad(unidad.id)"><i class="fa fa-unlock text-success"></i> Desactivar</a></li>
                                        </template>
                                        <template v-else>
                                            <li><a class="dropdown-item" href="#" @click="activarUnidad(unidad.id)"><i class="fa fa-lock text-danger"></i> Activar</a></li>
                                        </template>
                                    </ul>
                                </td>                                 
                            </tr>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                        ...
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                           ...
                           <div class="row mb-2" v-if="errores.nombre">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10"><input type="text" class="form-control" v-model="datos.abreviatura"></div>
                            </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" v-if="tipoAccion==1" class="btn btn-info text-white" @click="guardarUnidad()">Guardar</button>
                        <button type="button" v-if="tipoAccion==2" class="btn btn-info text-white" @click="modificarUnidad()">Modificar</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
        ...
        methods : {
            listarUnidad(page, buscar, criterio){
                ...
                axios.get(url).then(function(response){
                    me.arrayUnidad=response.data.data;
            ...
            listarCategoriaBusquedaRapida(){
                let me=this;
                var url='/unidad?page=' + 1 + '&buscar=' + me.buscar + '&criterio=' + me.criterio;
                axios.get(url).then(function(response){
                    me.arrayUnidad=response.data.data;
                    me.pagination={total:response.data.total, 
                        current_page:response.data.current_page,
            ...
            async guardarUnidad(){
                try {
                    let me = this;
                    const res = await axios.post('/unidad/guardar',this.datos);
                    if(res.data.error==0){
            ...
            modificarUnidad(){
                ...
                let me = this;
                axios.put('/unidad/modificar',this.datos).then(function(response){
                    Swal.fire({
                        position: 'top-end',
                        icon: 'success',
            ...
            validarUnidad(){
                ...
                if(!this.datos.nombre) this.errorMostrarMsjUnidad.push("El nombre del Cargo no puede estar vacio ");
                    ...
                    case "unidad_medida":
                        {
                            switch(accion){
                                case 'registrar':
                                    {
                                        this.modal = 1;
                                        this.tituloModal='Registro Presentación'
                                        this.datos = {
                                            id : 0,
                                            nombre : '',
                                            abreviatura : '',
                                ...
                                case 'modificar':
                                    {
                                        this.modal = 1;
                                        this.tituloModal = 'Modificar Presentación';
                                        this.tipoAccion = 2;
                                        this.datos.id = data['id'];
                                        this.datos.nombre = data['nombre'];
                                        this.datos.abreviatura = data['abreviatura'];
            ...
            desactivarUnidad(id){
                ...
                swalWithBootstrapButtons.fire({
                    title: 'Esta seguro de Inhabilitar esta Unidad Medida??',
                ...
                if (result.isConfirmed) {
                    let me = this;
                    axios.put('/unidad/desactivar',{'id': id}).then(function (response) {
                        me.listarUnidad(1,'', 'nombre');
                        swalWithBootstrapButtons.fire(
                        'Inhabilitado!',
                        'Este Unidad Medida se ha Inhabilitado.',
                        'success'
                        )
                    }).catch(function (error) {
                        console.log(error);
                    ...
                    swalWithBootstrapButtons.fire(
                    'Cancelado',
                    'Este Unidad Medida no ha tenido cambios :)',
                    'error'
                    )
                }
                })   
            ...
            activarUnidad(id){
                ...
                swalWithBootstrapButtons.fire({
                    title: 'Esta seguro de Habilitar este Unidad Medida??',
                    text: "Puede revertir esta decision!",
                    icon: 'warning',
                    showCancelButton: true,
                ...
                if (result.isConfirmed) {
                    let me = this;
                    axios.put('/unidad/activar',{'id': id}).then(function (response) {
                        me.listarUnidad(1,'', 'nombre');
                        swalWithBootstrapButtons.fire(
                        'Habilitado!',
                        'Esta Unidad Medida se ha Habilitado.',
                        'success'
                        )
                    }).catch(function (error) {
                        console.log(error);
                    ...
                    swalWithBootstrapButtons.fire(
                    'Cancelado',
                    'Esta Unidad Medida no ha tenido cambios :)',
                    'error'
                    )
                }
                })   
