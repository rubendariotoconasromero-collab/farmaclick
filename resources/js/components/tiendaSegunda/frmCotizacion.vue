    ...
    <main class="main">
        <!-- <div class="container"> -->
            <div class="row">
                ...
                &nbsp;
                    <div class="card">
                    <div class="card-header text-center text-white" style="background-color: #3399FF"><h3 class="mb-0">Cotizacion</h3></div>
                        <!-- Listado de Ventas -->
                            ...
                            <div class="card-body">
                                ...
                                <form class="row">
                                        ...
                                        <div class="input-group mb-6">
                                            ...
                                            <section class="dropdown-wrapper form-control bg-disabled">
                                                <div @click="isVisible = !isVisible" class="selected-item">
                                                    <span v-if="datos.cliente==''"   @change="cambiarDireccion(datos.cliente)">Seleccione Cliente</span>
                                    ...
                                    <div class="col-md-6" >
                                        ...
                                        <input type="number" class="form-control" v-model="datos.dias_credito" @keyup="cambiarDias()" min="0" >
                                    </div>
                                    <div class="col-md-6" >
                                ...
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end" style='width:96%;margin-left: 2.2%'>
                                    ...
                                    <button class="btn btn-info btn-lg text-white" type="button" @click="guardarCotizacion()">Guardar</button>
                                </div>
                            </div>
                        </template>
...
<script>
    ...
    export default {
        ...
        methods : {
            cambiarDias(){
                let me = this;
                me.datos.fecha_venci = moment().add(me.datos.dias_credito,'day').format('YYYY-MM-DD');
            },
            cambiarDireccion(cliente){
                let me = this;
                var url='/cliente_direccion?buscar=' + cliente ;
                axios.get(url).then(function(response){
                    me.arrayDireccion = response.data;
                    me.datos.lugar_entrega = me.arrayDireccion[0].direccion;
                })
            ...
            listarArticulo(buscarP){
                ...
                me.buscarCliente= '';
                me.isVisible = false;
                var url='/tienda/listarSinPaginate2/tienda2?buscar=' + buscarP;
                axios.get(url).then(function(response){
            ...
            selectedCliente(cliente){
                ...
                this.datos.lugar_entrega = cliente.direccion;
            },
            listarOrden(buscarP){
                let me = this;
                me.buscarCliente= '',
            ...
            seleccionarTiendaArticulo(data=[]){
                ...
                if(me.encuentra(data['id_articulo'])){
                    ...
                    me.datos.estado= 'Registrado';
                    me.datos.tipo_venta= 'Venta Cotizacion'
                    me.isDisabled = false;
            ...
            cargarPdf2() {
                axios.get('/cotizacion/pdfCotizacionReporte',{responseType: 'blob'})
                    .then(response => {
