    ...
    export default {
        ...
        methods : {
            listarVenta(page, buscar, criterio){
                let me=this;
                var url='/servicio_tienda2?page=' + page + '&buscar=' + buscar + '&criterio=' + criterio;
            ...
            listarVentaServicioVentaDirecta(){
                let me=this;
                var url='/servicio_tienda2?page=' + 1 + '&buscar=' + me.buscar + '&criterio=' + me.criterio;
                axios.get(url).then(function(response){
                    me.arrayVenta=response.data.data;
                    me.pagination={total:response.data.total, 
                        current_page:response.data.current_page,
            ...
            verVenta(data=[]){
                ...
                var url='/servicio/permiso/detalle_tienda2?id=' + data['id'];
                axios.get(url).then(function(response){
