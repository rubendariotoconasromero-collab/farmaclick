    ...
    export default {
        ...
        methods : {
            ...
            listarArticuloBusquedaRapida(){
                ...
                me.buscarCliente= '';
                me.isVisible = false;
                var url='/tienda/listarSinPaginate2/tienda2?buscar=' + me.buscarP;
                axios.get(url).then(function(response){
                    me.arrayArticulo= response.data;
                })
                .catch(function(error){
            ...
            listarOrden(buscarP){
                ...
                me.buscarCliente= '',
                me.isVisible = false;
                var url='/servicio/listarOrdenSinPaginate_tienda2?buscar=' + buscarP;
                axios.get(url).then(function(response){
            ...
            verVenta(data=[]){
                ...
                var url='/venta/permiso/detalle/tienda2?id=' + data['id'];
                axios.get(url).then(function(response){
            ...
            guardarVenta(){
                ...
                if(this.arrayDetalle.find(seg => (seg.stock - seg.cantidad < 0 && this.datos.tipo_venta!='Venta Servicio'))){
                    ...
                    if(this.datos.total < 0){
                        ...
                        let me = this;
                        axios.post('/venta/guardar_tienda2',{
            ...
            anularVenta(id){
                ...
                if (result.isConfirmed) {
                    let me = this;
                    axios.put('/venta/anular2',{'id': id}).then(function (response) {
                        Swal.fire(
                        'Habilitado!',
