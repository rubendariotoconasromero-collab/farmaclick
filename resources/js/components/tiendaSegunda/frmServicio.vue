                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody v-if="arrayArticuloServicio.length">
                                            <tr v-for="tienda_articulo in arrayArticuloServicio" :key="tienda_articulo.id">
                                                ...
                                                <td>
                                                    <button type="button" @click="seleccionarTiendaArticulo2(tienda_articulo)" @keyup="BuscandoProducto()" class="btn btn-success btn-sm"><i class="fa fa-check text-white"></i></button>   
                                                </td>                                 
                                            </tr>
                                        </tbody>
                                        <tbody v-else>
    ...
    export default {
        ...
        methods : {
            ...
            listarArticulo(buscarP){
                ...
                var url='/tienda/producto_tienda2?buscar=' + buscarP;
                axios.get(url).then(function(response){
            ...
            listarArticulo2(buscarP){
                ...
                me.buscarPersonal= '';
                me.isVisiblePersonal = false;
                var url='/tienda/servicio_tienda2?buscar=' + buscarP;
                axios.get(url).then(function(response){
            ...
            listarArticulo2BusquedaRapida(){
                ...
                me.buscarPersonal= '';
                me.isVisiblePersonal = false;
                var url='/tienda/servicio_tienda2?buscar=' + me.buscarP;
                axios.get(url).then(function(response){
                    me.arrayArticuloServicio= response.data;
                })
                .catch(function(error){
            ...
            guardarServicio(){
                ...
                if(this.arrayDetalle.find(seg => ( seg.tipo_producto == 'Producto Venta' ? seg.stock - seg.cantidad < 0 : ''))){
                    ...
                    if(this.datos.total < 0){
                        ...
                        let me = this;
                        axios.post('/servicio/guardar_tienda2',{
