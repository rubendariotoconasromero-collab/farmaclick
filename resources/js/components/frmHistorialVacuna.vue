                ...
                <div class="card">
                   <div class="card-header text-center text-white" style="background-color: #3399FF"><h3 class="mb-0">HISTORIAL DE VENTA</h3></div>
                    <template v-if="listado==0">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="cotizacion-tab" data-bs-toggle="tab" data-bs-target="#cotizacion" type="button" role="tab" aria-controls="cotizacion" aria-selected="false">Paquetes</button>
                        </li>
                        <!-- <li class="nav-item" role="presentation">
    ...
    export default {
        ...
        methods : {
            listarVenta(page, buscar, criterio){
                let me=this;
                var url='/venta_tienda1?page=' + page + '&buscar=' + buscar + '&criterio=' + criterio;
            ...
            listarVentaCotizacion(page, buscar, criterio){
                let me=this;
                var url='/ventaCotizacion_tienda1?page=' + page + '&buscar=' + buscar + '&criterio=' + criterio;
                axios.get(url).then(function(response){
            ...
            listarVentaBusquedaRapida(){
                let me=this;
                var url='/venta_tienda1?page=' + 1 + '&buscar=' + me.buscar + '&criterio=' + me.criterio;
                axios.get(url).then(function(response){
                    me.arrayVenta=response.data.data;
                    me.pagination={total:response.data.total, 
                        current_page:response.data.current_page,
