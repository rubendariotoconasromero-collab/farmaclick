            ...
            <div class="row">
                ...
                <div class="card">
                   <div class="card-header text-center text-white" style="background-color: #3399FF">
                        <h3 class="mb-0">PAGOS DE COMPRAS</h3>
                    </div>
                    <br>
                    ...
                    <div class="form-group row">
                        <div class="col-md-8">
                            <div class="input-group"  style='width:96%;margin-left: 3.3%'>
                                ...
                                &nbsp;&nbsp;&nbsp;
                                <input type="text" v-model="buscar" @keyup.enter="listarProveedor(buscar)" @keyup="BuscandoProveedor()" class="form-control" placeholder="Texto a buscar" style='width:30%'>
                                &nbsp;&nbsp;&nbsp;
                                <button type="submit" @click="listarProveedor(buscar)" class="btn btn-info text-white"><i class="fa fa-search"></i> buscar</button>
                            </div>
                        </div>
                    </div>
                    <br>
                    ...
                    <table class="table table-striped table-hover" style='width:96%;margin-left: 2.2%'>
                        ...
                        <tbody>
                            <tr v-for="cliente in arrayProveedor" :key="cliente.id">
            ...
            <div class="modal-dialog modal-dialog-centered modal-fullscreen" role="document">
                <div class="modal-content">
                    <div class="modal-header btn btn-info text-white">
                        <h4 class="modal-title ">Pago de Compra al Crédito</h4>
                                ...
                                <table class="table table-striped table-hover">
                                    <thead style="background-color: #46546C">
                                        <tr>          
                                            ...
                                            <th scope="col" class="text-white">Forma P.</th>
                                            <th scope="col" class="text-white">Saldo</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr v-for="(c_x_cobrar,index) in arrayCXCobrar" :key="c_x_cobrar.id">
                                            ...
                                            <td v-text="c_x_cobrar.formaP"></td>                                
