                ...
                <div class="card">
                   <div class="card-header text-center text-white" style="background-color: #3399FF">
                    ...
                    <div class="card-header">
                        <button type="button" @click="abrirModal('categoria','registrar')" class="btn btn-info text-white" style='margin-left: 1%'>
                    ...
                    <div class="form-group row">
                        <div class="col-md-8">
                            &nbsp;&nbsp;<div class="input-group" style='width:96%;margin-left: 3.3%'>
                                ...
                                &nbsp;&nbsp;&nbsp;
                                <input type="text" v-model="buscar" @keyup.enter="listarCategoria(1, buscar, criterio)"  @keyup="BuscandoCategoria()" class="form-control" placeholder="Texto a buscar">
                                &nbsp;&nbsp;&nbsp;
                                <button type="submit" @click="listarCategoria(1, buscar, criterio)" class="btn btn-info text-white"><i class="fa fa-search"></i> Buscar</button>
                            </div>
                        </div>
                    </div>
                    <br>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" v-if="tipoAccion==1" class="btn btn-info text-white" @click="guardarCategoria()">Guardar</button>
                        <button type="button" v-if="tipoAccion==2" class="btn btn-info text-white" @click="modificarCategoria()">Modificar</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
