                                ...
                                <tr v-for="servicio in arrayVentaServicio" :key="servicio.id">
                                    ...
                                    <td>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <!-- <template v-if="servicio.estado==1">
                                                <li><a class="dropdown-item" href="#" @click="desactivarCompra(servicio.id)"><i class="fa fa-unlock text-success"></i> Desactivar</a></li>
                                            </template>
                                            <template v-else>
                                                <li><a class="dropdown-item" href="#" @click="anularCompra(servicio.id)"><i class="fa fa-lock text-danger"></i> Anular</a></li>
                                            </template> -->
                                        </ul>
                                    </td>                              
                                </tr>
    ...
    export default {
        ...
        methods : {
            ...
            listarVentaBusquedaRapida(){
                let me=this;
                var url='/venta?page=' + 1 + '&buscar=' + me.buscar + '&criterio=' + me.criterio;
                axios.get(url).then(function(response){
                    me.arrayVenta=response.data.data;
                    me.pagination={total:response.data.total, 
                        current_page:response.data.current_page,
            ...
            listarVentaServicioBusquedaRapida(){
                let me=this;
                var url='/ventaServicio?page=' + 1 + '&buscar=' + me.buscar + '&criterio=' + me.criterio;
                axios.get(url).then(function(response){
                    me.arrayVentaServicio=response.data.data;
                    me.paginationServicio={total:response.data.total, 
                        current_page:response.data.current_page,
            ...
            anularVenta(id){
                ...
                if (result.isConfirmed) {
                    let me = this;
                    axios.put('/venta/anular',{'id': id}).then(function (response) {
                        me.listarVenta(1,'', 'nombre');
                        swalWithBootstrapButtons.fire(
                        'Habilitado!',
