                ...
                <div class="card">
                   <div class="card-header text-center text-white" style="background-color: #3399FF">
                    ...
                    <div class="card-header">
                        <button type="button" @click="abrirModal('marca','registrar')" class="btn btn-info text-white" style='margin-left: 1%'>
                    ...
                    <div class="form-group row">
                        <div class="col-md-8">
                            &nbsp;&nbsp;<div class="input-group" style='width:96%;margin-left: 3.3%'>
                                ...
                                &nbsp;&nbsp;&nbsp;
                                <input type="text" v-model="buscar" @keyup.enter="listarMarca(1, buscar, criterio)"  @keyup="BuscandoMarca()" class="form-control" placeholder="Texto a buscar">
                                &nbsp;&nbsp;&nbsp;
                                <button type="submit" @click="listarMarca(1, buscar, criterio)" class="btn btn-info text-white"><i class="fa fa-search"></i> Buscar</button>
                            </div>
                        </div>
                    </div>
                    <br>
                            ...
                            <tr v-for="marca in arrayMarca" :key="marca.id">
                                ...
                                <td>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li><a class="dropdown-item" href="#" @click="abrirModal('marca','modificar',marca)"><i class="fa fa-edit text-warning"></i> Modificar</a></li>
                                        <template v-if="marca.estado==1">
                                            <li><a class="dropdown-item" href="#" @click="desactivarMarca(marca.id)"><i class="fa fa-unlock text-success"></i> Desactivar</a></li>
                                        </template>
                                        <template v-else>
                                            <li><a class="dropdown-item" href="#" @click="activarMarca(marca.id)"><i class="fa fa-lock text-danger"></i> Activar</a></li>
                                        </template>
                                    </ul>
                                </td>                                 
                            </tr>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" v-if="tipoAccion==1" class="btn btn-info text-white" @click="guardarMarca()">Guardar</button>
                        <button type="button" v-if="tipoAccion==2" class="btn btn-info text-white" @click="modificarMarca()">Modificar</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
        ...
        methods : {
            listarMarca(page, buscar, criterio){
                ...
                axios.get(url).then(function(response){
                    me.arrayMarca=response.data.data;
            ...
            listarCategoriaBusquedaRapida(){
                let me=this;
                var url='/marca?page=' + 1 + '&buscar=' + me.buscar + '&criterio=' + me.criterio;
                axios.get(url).then(function(response){
                    me.arrayMarca=response.data.data;
                    me.pagination={total:response.data.total, 
                        current_page:response.data.current_page,
            ...
            async guardarMarca(){
                try {
                    let me = this;
                    const res = await axios.post('/marca/guardar',this.datos);
                    if(res.data.error==0){
            ...
            modificarMarca(){
                ...
                let me = this;
                axios.put('/marca/modificar',this.datos).then(function(response){
                    Swal.fire({
                        position: 'top-end',
                        icon: 'success',
                    ...
                    case "marca":
                        {
                            switch(accion){
                                case 'registrar':
                                    {
                                        this.modal = 1;
                                        this.tituloModal='Registro Linea'
                                        this.datos = {
                                            id : 0,
                                            nombre : '',
                                            descripcion : '',
                                ...
                                case 'modificar':
                                    {
                                        this.modal = 1;
                                        this.tituloModal = 'Modificar Linea';
                                        this.tipoAccion = 2;
            ...
            desactivarMarca(id){
                ...
                if (result.isConfirmed) {
                    let me = this;
                    axios.put('/marca/desactivar',{'id': id}).then(function (response) {
                        me.listarMarca(1,'', 'nombre');
                        swalWithBootstrapButtons.fire(
                        'Inhabilitado!',
            ...
            activarMarca(id){
                ...
                if (result.isConfirmed) {
                    let me = this;
                    axios.put('/marca/activar',{'id': id}).then(function (response) {
                        me.listarMarca(1,'', 'nombre');
                        swalWithBootstrapButtons.fire(
                        'Habilitado!',
