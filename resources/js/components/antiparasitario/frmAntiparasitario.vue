    ...
    <main class="main">
        <!-- <div class="container"> -->
            <div class="row">
                ...
                &nbsp;
                    <div class="card">
                    <div class="card-header text-center text-white" style="background-color: #3399FF"><h3 class="mb-0">ANTIPARASITARIO</h3></div>
                        <!-- Listado de Ventas -->
                            ...
                            <div class="card-body">
                                ...
                                <form class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <button type="button" disabled class="btn btn-info text-white" data-bs-toggle="modal" data-bs-target="#modalArticulo" @click="listarArticulo(buscarP)"><i class="fa fa-search"></i> Agregar Antiparasitarios</button>
                                    </div> 
                                    </template>
                                    <template v-else>
                                    <div class="col-md-12">
                                        <label>Vacunas<span style="color:red;" >(*Seleccione)</span></label>
                                        <button type="button"  class="btn btn-info text-white" data-bs-toggle="modal" data-bs-target="#modalArticulo" @click="listarArticulo(buscarP)"  :disabled="isDisabledProducto"><i class="fa fa-search"></i> Agregar Antiparasitarios</button>
                                    </div> 
                                    </template>
                                </form>           
                                    <div class="col-md-12">
                                    ...
                                    <table class="table table-striped table-hover" style='width:96%;margin-left: 2%'>
                                        ...
                                        <tbody v-if="arrayDetalle.length">
                                            <tr v-for="(detalle,index) in arrayDetalle" :key="detalle.id">
                                                ...
                                                <!-- <td v-text="detalle.costo_unitario"> -->
                ...
                if(this.arrayDetalle.find(seg => (seg.stock - seg.cantidad < 0 && this.datos.tipo_venta!='Venta Servicio'))){
                    Swal.fire({
                        ...
                        if(this.datos.total < 0){
                            ...
                            let me = this;
                            axios.post('/antiparasitario/guardar',{
                                ...
                                Swal.fire({
                                    position: 'top-end',
                                    icon: 'success',
                                    title: 'Antiparasitario registrado exitosamente',
                                    showConfirmButton: false,
                                    timer: 1500
                                });
                                //me.cargarPdf2();
