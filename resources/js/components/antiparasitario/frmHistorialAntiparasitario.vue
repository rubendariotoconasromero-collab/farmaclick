<template>
    <main class="main">
        <div class="row">
            ...
            &nbsp;
            <div class="card">
                <div class="card-header text-center text-white" style="background-color: #3399FF"><h3 class="mb-0">HISTORIAL ANTIPARASITARIO</h3></div>
                <template v-if="listado==0">
                    ...
                    <div class="form-group row">
                        <div class="col-md-8">
                            &nbsp;&nbsp;<div class="input-group" style='width:96%;margin-left: 3.3%'>
                                ...
                                &nbsp;&nbsp;&nbsp;
                                <input type="text" v-model="buscar" @keyup.enter="listarAntiparasitario(1, buscar, criterio)" @keyup="BuscandoVenta()" class="form-control" placeholder="Texto a buscar">
                                &nbsp;&nbsp;&nbsp;
                                <button type="submit" @click="listarAntiparasitario(1, buscar, criterio)" class="btn btn-info text-white"><i class="fa fa-search"></i> Buscar</button>
                            </div>
                        </div>
                    </div>
                    <br>
                    ...
                    <table class="table table-striped table-hover" style='width:96%;margin-left: 2.2%'>
                        ...
                        <tbody>
                            <tr v-for="control_vacuna in arrayAntiparasitario" :key="control_vacuna.id">
                                <td v-text="control_vacuna.cliente"></td>
                                <td v-text="control_vacuna.paciente"></td>
                                <td v-text="control_vacuna.peso"></td>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <template v-if="control_vacuna.estado!='Anulado'">
                                            <template v-if="control_vacuna.estado!='Entregado'">
                                                ...
                                                <!-- <li><a class="dropdown-item" href="#" @click="vender(control_vacuna)"><i class="fa fa-inbox text-primary"></i> Vender</a></li> -->
                                            </template>
                                        </template>
                                        <!-- <template v-if="control_vacuna.estado!='Anulado'">
                                            <template v-if="control_vacuna.estado!='Entregado'">
                    ...
                    <div class="card-body">
                        ...
                        <form class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control"  v-model="datos.peso">  
                            </div>
                            <div class="col-md-6">
                            </div>&nbsp;
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end" style='width:96%;margin-left: 2.2%'>
                            ...
                            <button class="btn btn-info btn-lg text-white" type="button" @click="modificarAntiparasitario()">Guardar</button>
                        </div>
                    </div>
                </template>
                <!-- Fin de modificar -->
                ...
                <template v-if="listado==2">
                    <div class="card-header row m-0">
                        ...
                        <div class="col-md-4 text-center"><h3 class="mb-0">REGISTRO ANTIPARASITARIO</h3></div>
                        <div class="col-md-4">&nbsp;</div>
                        <!-- <div class="col-md-2">
                            <img :src="'img/mi_empresa/'+ datos.foto" height="50px" align="left" alt=""> 
                        </div>  -->
                            ...
                            <form class="row">
                                <div class="col-md-6">
                                 ...
                                 <div class="col-md-6" >
                                    ...
                                    <div class="col-md-6">
                                        <label for="exampleInputPassword1" class="form-label">Peso</label>
                                        <input type="number" class="form-control" v-model="datos.peso" disabled >
                                    </div>
                                &nbsp;
...
<script>
    ...
    export default {
        ...
        methods : {
            ...
            listarAntiparasitario(page, buscar, criterio){
                let me=this;
                var url='/antiparasitario?page=' + page + '&buscar=' + buscar + '&criterio=' + criterio;
                axios.get(url).then(function(response){
                    me.arrayAntiparasitario=response.data.data;
            ...
            cambiarPagina(page, buscar, criterio){
                ...
                me.listarAntiparasitario(page, buscar, criterio);
            },
            listarArticulo(buscarP, criterioP){
                let me = this;
                me.buscarPaciente= '';
                me.isVisible = false;
                var url='/tienda/listarSinPaginateControlAntiparasitario?id_animal='+me.datos.id_animal+'&buscar=' + buscarP + '&criterio=' + criterioP;
                axios.get(url).then(function(response){
            ...
            verControl(data=[]){
                ...
                me.datos.peso=data['peso'];
            
        
                var url='/antiparasitario/permiso/detalle?id=' + data['id'];
                axios.get(url).then(function(response){
                    me.arrayDetalle= response.data;
                })
                .catch(function(error){
            ...
            editarDetalle(data=[]){
                ...
                var url='/antiparasitario/estado?id='+ data['id'];
                axios.put(url).then(function(response){
                    //me.arrayDetalle = response.data;
                })
                .catch(function(error){
                ...
                if(this.arrayDetalle.find(seg => (seg.stock - seg.cantidad < 0 && this.datos.tipo_venta!='Venta Servicio'))){
                    Swal.fire({
                        ...
                        if(this.datos.total < 0){
                            ...
                            let me = this;
                            axios.put('/antiparasitario/modificar',{
                                ...
                                Swal.fire({
                                    position: 'top-end',
                                    icon: 'success',
                                    title: 'Registro de Antiparasitario exitosamente',
                                    showConfirmButton: false,
                                    timer: 1500
                                });
                                //me.cargarPdf2();
                                ...
                                me.listarAntiparasitario(1, '', 'nombre');
            ...
            this.downloadReport(time);
                axios.get('/antiparasitario//pdfAntiparacitario?id=' + id,{responseType: 'blob'})
                    .then(response => {
        ...
        mounted() {
            this.listarAntiparasitario(1, this.buscar, this.criterio);
            this.selectFormaP();   
            this.selectTipoP(); 
            this.verificarCaja();
            // this.selectCliente();
