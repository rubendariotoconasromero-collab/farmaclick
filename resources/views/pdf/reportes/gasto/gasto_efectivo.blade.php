            ...
            <table class="table" style="">
                ...
                <thead style="border: 1px solid black; background-color:<?php echo $color1; ?>">
                    <tr> 
                        ...
                        <th style="vertical-align: middle; border-right: 2px solid black ;color:#FFFFFF" width="30%" style="">{{__('T. Efectivo')}}</th>
                        @endif
                        @if($det['id_forma_pago'] ==6)
                        ...
                        <th style="vertical-align: middle; border-right: 2px solid black ;color:#FFFFFF"  width="10%" style="">{{__('D. Deposito')}}</th>
                        @endif
