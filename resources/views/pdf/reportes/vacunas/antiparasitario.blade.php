        ...
        <div class="col-lg-7 col-md-7" style=" color: black">        
            <table class="table" style="">
                <thead style="border: 1px solid black; background-color:<?php echo $color1; ?>">
                    <tr> 
                        <th style="vertical-align: middle; border-right: 2px solid black ;color:#FFFFFF" width="25%" style="">{{__('FECHA')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black ;color:#FFFFFF" width="25%" style="">{{__('PESO')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black ;color:#FFFFFF" width="25%" style="">{{__('VACUNAS')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black ;color:#FFFFFF" width="25%" style="">{{__('PROX. FECHA')}}</th>
                        {{-- <th style="vertical-align: middle; border-right: 2px solid black" width="20%" style="">{{__('Descuento')}}</th> --}}
                    </tr>
                </thead>
                ...
                <tbody  style="border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black">
                    <tr style="border-top: 1px solid black">
                        ...
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det['peso'] }}</td>
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det['vacuna']}}</td>
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det['prox_fecha']}}</td>
                        {{-- @if($det['descuento'] == 1)
                        <td style="text-align: center; border-right: 1px solid black;">{{__('Unitario')}}</td>
                        @endif --}}
                        {{-- @if($det['descuento'] == 2)
                        <td style="text-align: center; border-right: 1px solid black;">{{__('Mayorista')}}</td>
                        @endif
                        @if($det['descuento'] == 3)
                        <td style="text-align: center; border-right: 1px solid black;">{{__('Preferencial')}}</td>
                        @endif --}}
                    </tr>
                    @php
                        $numero++;
