            ...
            <table class="table" style="">
                <thead style="border: 1px solid black; background-color:<?php echo $color1; ?>">
                    <tr> 
                        ...
                        <th style="vertical-align: middle; border-right: 2px solid black ;color:#FFFFFF" width="40%" style="">{{__('Producto')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black ;color:#FFFFFF" width="20%" style="">{{__('Laboratorio')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black ;color:#FFFFFF" width="10%" style="">{{__('Cantidad')}}</th>
                ...
                <tbody  style="border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black">
                    <tr style="border-top: 1px solid black">
                        ...
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det['nombre_comercial']}}</td>
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det['laboratorio']}}</td>
