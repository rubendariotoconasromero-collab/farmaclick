            ...
            <table class="table" style="">
                <thead style="border: 1px solid black; background-color:<?php echo $color1; ?>">
                    <tr> 
                        ...
                        <th style="vertical-align: middle; border-right: 2px solid black" width="20%" style="">{{__('Cod. Producto')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black" width="20%" style="">{{__('Cod. Proveedor')}}</th> --}}
                        <th style="vertical-align: middle; border-right: 2px solid black" width="20%" style="">{{__('Categoria')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black" width="35%" style="">{{__('Nombre')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black" width="20%" style="">{{__('Marca')}}</th>
                        {{-- <th style="vertical-align: middle; border-right: 2px solid black" width="20%" style="">{{__('Costo de Compra')}}</th> --}}
                        <th style="vertical-align: middle; border-right: 2px solid black" width="20%" style="">{{__('Precio Unitario')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black" width="20%" style="">{{__('Precio Mayorista')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black" width="20%" style="">{{__('Precio Preferencial')}}</th>
                        {{-- <th style="vertical-align: middle; border-right: 2px solid black" width="20%" style="">{{__('Tienda')}}</th> --}}
                        <th style="vertical-align: middle; border-right: 2px solid black" width="20%" style="">{{__('Stock')}}</th>
                    </tr>
                </thead>
                ...
                <tbody  style="border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black">
                    <tr style="border-top: 1px solid black">
                        ...
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det['cod_producto'] }}</td>
                        ...
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det['nombre']}}</td>
                        ...
                        {{-- <td style="text-align: center; border-right: 1px solid black;">{{ $det['tienda']}}</td> --}}
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det['total_stock']}}</td>
                    </tr>
                    @php
                        $numero++;
                    @endphp
