            ...
            <table class="table" style="">
                <thead style="border: 1px solid black; background-color:<?php echo $color1; ?>">
                    <tr> 
                        ...
                        <th style="vertical-align: middle; border-right: 2px solid black ;color:#FFFFFF"  width="20%" style="">{{__('Propietario')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black ;color:#FFFFFF"  width="20%" style="">{{__('Mascota')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black ;color:#FFFFFF"  width="20%" style="">{{__('Animal')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black ;color:#FFFFFF"  width="35%" style="">{{__('Especie')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black ;color:#FFFFFF"  width="20%" style="">{{__('Descripción')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black ;color:#FFFFFF"  width="20%" style="">{{__('Color')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black ;color:#FFFFFF"  width="20%" style="">{{__('Raza')}}</th>
                    </tr>
                </thead>
                ...
                <tbody  style="border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black">
                    <tr style="border-top: 1px solid black">
                        ...
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det['mascota']}}</td>
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det['animal']}}</td>
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det['especie']}}</td>
                        @if($det['sexo']!=0)
                            <td style="text-align: center; border-right: 1px solid black;">{{'Macho'}}</td>
                        @else
                            <td style="text-align: center; border-right: 1px solid black;">{{'Hembra'}}</td>
                        @endif    
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det['color']}}</td>
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det['raza']}}</td>
                    </tr>
                    @php
                        $numero++;
                    @endphp
