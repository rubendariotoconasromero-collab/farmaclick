    ...
    <table style="width: 100%; border-collapse: collapse; margin-bottom: 0px; table-layout: fixed;">
        <tr>
            ...
            <td style="text-align: center; vertical-align: middle; padding: 10px;">
                <div style="font-size: 20px; font-weight: bold; color: {{ $colors['color1'] }}; line-height: 1.3; margin: 0; padding: 0;">
                    {{ strtoupper($title) }}
                </div>
            </td>
            ...
            <table class="table" style="">
                <thead style="border: 1px solid black; background-color:<?php echo $color1; ?>">
                    <tr> 
                        ...
                        <th style="vertical-align: middle; border-right: 2px solid black ;color:#FFFFFF"  width="20%" style="">{{__('Cod. Proveedor')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black ;color:#FFFFFF"  width="20%" style="">{{__('Nombre')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black ;color:#FFFFFF"  width="35%" style="">{{__('Nit')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black ;color:#FFFFFF"  width="20%" style="">{{__('Contacto')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black ;color:#FFFFFF"  width="20%" style="">{{__('Dirección')}}</th>
                ...
                <tbody  style="border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black">
                    <tr style="border-top: 1px solid black">
                        ...
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det['id'] }}</td>
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det['nombre']}}</td>
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det['nit']}}</td>
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det['contacto']}}</td>
