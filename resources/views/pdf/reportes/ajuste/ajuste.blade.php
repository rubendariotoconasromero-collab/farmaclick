            ...
            <table class="table" style="">
                <thead style="border: 1px solid black; background-color:<?php echo $color1; ?>">
                    <tr> 
                        ...
                        <th style="vertical-align: middle; border-right: 2px solid black" width="20%" style="">{{__('Producto')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black" width="35%" style="">{{__('Marca')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black" width="20%" style="">{{__('Stock')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black" width="20%" style="">{{__('Stock Anterior')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black" width="20%" style="">{{__('Stock Actual')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black" width="35%" style="">{{__('Motivo')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black" width="20%" style="">{{__('Costo Compra')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black" width="20%" style="">{{__('Precio Unitario')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black" width="35%" style="">{{__('Precio Mayorista')}}</th>
                ...
                <tbody  style="border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black">
                    <tr style="border-top: 1px solid black">
                        ...
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det['stock_anterior']}}</td>
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det['stock_actual'] }}</td>
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det['motivo_ajuste']}}</td>
