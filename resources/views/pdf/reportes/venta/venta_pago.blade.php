        ...
        <div class="col-lg-7 col-md-7" style=" color: black">
            ...
            <table class="table" style="">
                <thead style="border: 1px solid black">
                    <tr> 
                        <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF; font-weight: normal; background-color:<?php echo $color1; ?>" width="30%"><strong>{{__('Cliente')}}</strong></th>
                    ...
                    <tr> 
                        <th style="vertical-align: middle; border-right: 2px solid black; font-weight: normal; " width="30%">{{$pago['cliente']}}</th>
