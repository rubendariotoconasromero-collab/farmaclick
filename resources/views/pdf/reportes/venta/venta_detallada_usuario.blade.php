...
<body>
    <table class="table-head" style="width: 100%; margin-bottom: 20px;">
        <tr>
            ...
            <th rowspan="3" style="width: 10%; text-align: center; vertical-align: middle; padding: 5px;">
                <img src="{{ $logo_sistema ? 'img/logo/' . $logo_sistema : '' }}" height="60" alt="Company Logo">
            </th>
            ...
            <th style='width: 100px; text-align: center; vertical-align: middle; padding: 10px;'>             
            </th>
        </tr>
    </table>
    ...
    <table class="table" style="width: 100%; margin-bottom: 20px; border-collapse: collapse;">
        <thead>
            <tr>
                <th colspan="2" style="font-size:12px; background-color: {{ $colors['color1'] }}; color: #FFF; padding: 5px; text-align: left; border: 1px solid #dedede;">
                    Total Venta: {{ number_format($detalles2[0]['totalV'], 2) }}
                </th>
            </tr>
            <tr>
                <th style="font-size:12px; background-color: #5386a5; color: #FFF; padding: 5px; text-align: left; border: 1px solid #dedede;">
            ...
            <tr>
                <th colspan="2" style="font-size:12px; background-color: #a0d2f3; padding: 5px; text-align: left; border: 1px solid #dedede;">
