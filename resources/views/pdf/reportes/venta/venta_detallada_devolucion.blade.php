        ...
        <div class="col-lg-7 col-md-7" style=" color: black">   
            ...
            <table class="table" style="">
                <thead style="border: 1px solid black">
                    <tr> 
                        <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF; font-weight: normal; background-color:<?php echo $color1; ?>" width="30%"><strong>{{__('Cliente:')}}</strong> {{$comp['cliente']}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF; font-weight: normal; background-color:<?php echo $color1; ?>" width="20%"><strong>{{__('Tipo P.:')}}</strong> {{$comp['tipo_pago']}}</th>
                        {{-- <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF; font-weight: normal; background-color:<?php echo $color1; ?>" width="20%"><strong>{{__('Usuario.:')}}</strong> {{$comp['usuario']}}</th> --}}
                        <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF; font-weight: normal; background-color:<?php echo $color1; ?>" width="20%"><strong>{{__('Desc.:')}}</strong> {{$comp['descuento']}}</th>
                ...
                <tbody  style="border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black">
                    <tr style="border-top: 1px solid black">
                        ...
                        <td colspan="1" style="text-align: left; border-right: 1px solid black;"><strong>{{__('Usuario:')}}</strong>{{ $det['usuario']}}</td>
                        @else
