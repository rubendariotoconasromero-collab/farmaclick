            ...
            <table class="table" style="">
                <thead style="border: 1px solid black; background-color:<?php echo $color1; ?>">
                    <tr> 
                        ...
                        <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF" width="20%" style="">{{__('Fecha Apertura')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF" width="20%" style="">{{__('Fecha Cierre')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF" width="20%" style="">{{__('Apertura')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF" width="35%" style="">{{__('Ingreso')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF" width="20%" style="">{{__('Egreso')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF" width="20%" style="">{{__('Total Efectivo')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF" width="20%" style="">{{__('Usuario')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF" width="20%" style="">{{__('Estado')}}</th>
                    </tr>
                </thead>
                ...
                <tbody  style="border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black">
                    <tr style="border-top: 1px solid black">
                        ...
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det['fecha_apertura'] }}</td>
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det['fecha_cierre'] }}</td>
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det['apertura']}}</td>
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det['ingreso']}}</td>
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det['egreso']}}</td>
                        ...
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det['estado']}}</td>
                    </tr>
                    @php
                        $numero++;
                    @endphp
