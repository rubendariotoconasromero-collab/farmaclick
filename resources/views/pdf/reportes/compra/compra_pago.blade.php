        ...
        <div class="col-lg-7 col-md-7" style=" color: black">
            ...
            <table class="table" style="">
                <thead style="border: 1px solid black">
                    <tr> 
                        <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF; font-weight: normal; background-color:<?php echo $color1; ?>" width="30%"><strong>{{__('Proveedor')}}</strong></th>
                        <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF; font-weight: normal; background-color:<?php echo $color1; ?>" width="20%"><strong>{{__('Fecha Inico')}}</strong></th>
                        <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF; font-weight: normal; background-color:<?php echo $color2; ?>" width="15%"><strong>{{__('Fecha Final')}}</strong></th>
                        <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF; font-weight: normal; background-color:<?php echo $color2; ?>" width="15%"><strong>{{__('Monto')}}</strong></th>
                        <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF; font-weight: normal; background-color:<?php echo $color2; ?>" width="15%"><strong>{{__('Saldo')}}</strong></th>
                    </tr>
                    <tr> 
                        <th style="vertical-align: middle; border-right: 2px solid black; font-weight: normal; " width="30%">{{$pago['proveedor']}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black; font-weight: normal; " width="20%">{{$pago['fecha']}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black; font-weight: normal; " width="15%">{{$pago['fecha_final']}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black; font-weight: normal; " width="15%">{{$pago['monto']}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black; font-weight: normal; " width="15%">{{$pago['saldo']}}</th>
                    </tr>
                </thead>
                    ...
                    @foreach($detalles as $det)
                        @if($pago['id']==$det['id_pago'])
                            ...
                            <tr style="border-top: 1px solid black">
                                <td style="text-align: left; border-right: 1px solid black;">{{ $det['descripcion']}}</td>
                                <td style="text-align: center; border-right: 1px solid black;">{{__('Pago')}} {{ $numero }}</td>
                                <td style="text-align: center; border-right: 1px solid black;">{{ $det['fecha']}}</td>
                                <td style="text-align: center; border-right: 1px solid black;">{{ $det['amortizacion'] }}</td>
                                <td style="text-align: center; border-right: 1px solid black;">{{ $det['saldo']}}</td>
                            </tr>
                                {{-- @if($det == [])
                                    <tr style="border-top: 1px solid black">
                                        <td colspan="5" style="text-align: left; border-right: 1px solid black;">{{__('No se ha realizado ningun pago')}}</td>
                                    </tr>
                                @endif --}}
                            @php $numero++; @endphp
                            @endif
            ...
            <table class="table" style="">
                ...
                <tbody  style="border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black">
                    <tr style="border-top: 1px solid black">
                        <td colspan="5" style="text-align: left; border-right: 1px solid black;">{{__('No se encuentran registro entre estas fechas')}}</td>
                    </tr>
                </tbody>
            </table>
            @endif
