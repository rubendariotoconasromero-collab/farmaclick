        ...
        <div class="col-lg-7 col-md-7" style=" color: black">   
            ...
            <table class="table" style="">
                <thead style="border: 1px solid black">
                    <tr> 
                        <th style="vertical-align: middle; border-right: 2px solid black ;color:#FFFFFF; font-weight: normal; background-color:<?php echo $color1; ?>" width="30%"><strong>{{__('Proveedor:')}}</strong> {{$comp['proveedor']}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black ;color:#FFFFFF; font-weight: normal; background-color:<?php echo $color1; ?>" width="20%"><strong>{{__('Tipo P.:')}}</strong> {{$comp['tipo']}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black ;color:#FFFFFF; font-weight: normal; background-color:<?php echo $color1; ?>" width="20%"><strong>{{__('Forma P.:')}}</strong> {{$comp['forma'] == 'Cuenta por Cobrar' ? 'Cuenta por Pagar' : $comp['forma']}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black ;color:#FFFFFF; font-weight: normal; background-color:<?php echo $color1; ?>" width="20%"><strong>{{__('Descuento:')}}</strong> {{$comp['descuento']}}</th>
                        @if($comp['forma'] == 'Efectivo')
                       ...
                       @elseif($comp['forma'] == 'Transferencia')
                            ...
                            <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF; font-weight: normal; background-color:<?php echo $color1; ?> ; ?>" width="20%"><strong>{{__('Total E.:')}}</strong> {{$comp['total_efectivo']}}</th>
                            <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF; font-weight: normal; background-color:<?php echo $color1; ?>" width="20%"><strong>{{__('Total D.:')}}</strong> {{$comp['total_deposito']}}</th>
                        @elseif($comp['forma'] == 'Pago por QR')
                            <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF; font-weight: normal; background-color:<?php echo $color1; ?>" width="20%"><strong>{{__('Total:')}}</strong> {{$comp['total_deposito']}}</th>
                            <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF; font-weight: normal; background-color:<?php echo $color1; ?> ; ?>" width="20%"><strong>{{__('Total E.:')}}</strong> {{$comp['total_efectivo']}}</th>
                            <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF; font-weight: normal; background-color:<?php echo $color1; ?>" width="20%"><strong>{{__('Total D.:')}}</strong> {{$comp['total_deposito']}}</th>
                        @elseif($comp['forma'] == 'Depósito')
                            <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF; font-weight: normal; background-color:<?php echo $color1; ?>" width="20%"><strong>{{__('Total:')}}</strong> {{$comp['total_deposito']}}</th>
                            <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF; font-weight: normal; background-color:<?php echo $color1; ?> ; ?>" width="20%"><strong>{{__('Total E.:')}}</strong> {{$comp['total_efectivo']}}</th>
                            <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF; font-weight: normal; background-color:<?php echo $color1; ?>" width="20%"><strong>{{__('Total D.:')}}</strong> {{$comp['total_deposito']}}</th>
                        @elseif($comp['forma'] == 'Cuenta por Cobrar')
                        ...
                        @elseif($comp['forma'] == 'Mixta')
                            <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF; font-weight: normal; background-color:<?php echo $color1; ?>" width="20%"><strong>{{__('Total:')}}</strong> {{$comp['total']}}</th>
                            <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF; font-weight: normal; background-color:<?php echo $color1; ?>" width="20%"><strong>{{__('Total E.:')}}</strong> {{$comp['total_efectivo']}}</th>
                            <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF; font-weight: normal; background-color:<?php echo $color1; ?>" width="20%"><strong>{{__('Total D.:')}}</strong> {{$comp['total_deposito']}}</th>
                          @endif
                        <th style="vertical-align: middle; border-right: 2px solid black ;color:#FFFFFF; font-weight: normal; background-color:<?php echo $color2; ?>" width="15%"><strong>{{__('Cantidad')}}</strong></th>
                        <th style="vertical-align: middle; border-right: 2px solid black ;color:#FFFFFF; font-weight: normal; background-color:<?php echo $color2; ?>" width="15%"><strong>{{__('PU')}}</strong></th>
                        <th style="vertical-align: middle; border-right: 2px solid black ;color:#FFFFFF; font-weight: normal; background-color:<?php echo $color2; ?>" width="15%"><strong>{{__('Sub Total:')}}</strong> {{$comp['sub_total']}}</th>
                    </tr>
                </thead>
                ...
                <tbody  style="border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black">
                    ...
                    <tr style="border-top: 1px solid black">
                        @if($comp['forma'] == 'Mixta' || $comp['forma'] == 'Efectivo' || $comp['forma'] == 'Transferencia' || $comp['forma'] == 'Pago por QR' || $comp['forma'] == 'Depósito')
                        <td colspan="6" style="text-align: left; border-right: 1px solid black;">{{ $det['producto']}}</td>
                        @else
                        <td colspan="5" style="text-align: left; border-right: 1px solid black;">{{ $det['producto']}}</td>
                        @endif
                        <td style="text-align: center; border-right: 1px solid black;"><strong>{{__('Descuento:')}}</strong>{{ $det['descuento']}}</td>
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det['cantidad']}}</td>
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det['pu'] }}</td>
