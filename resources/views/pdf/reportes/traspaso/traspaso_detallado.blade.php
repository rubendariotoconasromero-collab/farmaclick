        ...
        <div class="col-lg-7 col-md-7" style=" color: black">   
            ...
            <table class="table" style="">
                <thead style="border: 1px solid black">
                    <tr> 
                        <th colspan="2" style="vertical-align: middle; border-right: 2px solid black; font-weight: normal; background-color:<?php echo $color1; ?>" width="20%"><strong>{{__('Fecha:')}}</strong> {{$trasp['fecha']}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black; font-weight: normal; background-color:<?php echo $color1; ?>" width="15%"><strong>{{__('Tienda Origen:')}}</strong> {{$trasp['tienda1']}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black; font-weight: normal; background-color:<?php echo $color1; ?>" width="15%"><strong>{{__('Tienda Destion:')}}</strong> {{$trasp['tienda2']}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black; font-weight: normal; background-color:<?php echo $color1; ?>; text-align: left" width="35%"><strong>{{__('Glosa:')}}</strong> {{$trasp['glosa']}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black; font-weight: normal; background-color:<?php echo $color1; ?>" width="15%"><strong>{{__('Usuario:')}}</strong> {{$trasp['name']}}</th>
                    </tr>
                </thead>
                <thead style="border: 1px solid black">
                    <tr> 
                        <th style="vertical-align: middle; border-right: 2px solid black; font-weight: normal; background-color:<?php echo $color2; ?>" ><strong>{{__('C. Producto')}}</strong></th>
                        <th style="vertical-align: middle; border-right: 2px solid black; font-weight: normal; background-color:<?php echo $color2; ?>" ><strong>{{__('C. Proveedor')}}</strong></th>
                        <th style="vertical-align: middle; border-right: 2px solid black; font-weight: normal; background-color:<?php echo $color2; ?>" ><strong>{{__('Categoria')}}</strong></th>
                        <th style="vertical-align: middle; border-right: 2px solid black; font-weight: normal; background-color:<?php echo $color2; ?>" ><strong>{{__('Marca')}}</strong></th>
                        <th style="vertical-align: middle; border-right: 2px solid black; font-weight: normal; background-color:<?php echo $color2; ?>; text-align: center" ><strong>{{__('Producto')}}</strong></th>
                        <th style="vertical-align: middle; border-right: 2px solid black; font-weight: normal; background-color:<?php echo $color2; ?>" ><strong>{{__('Cantidad')}}</strong></th>
                    </tr>
                </thead>
                ...
                <tbody  style="border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black">
                    ...
                    <tr style="border-top: 1px solid black">
                        <td style="text-align: left; border-right: 1px solid black;">{{ $det['cod_producto']}}</td>
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det['cod_proveedor']}}</td>
                        ...
                        <td style="text-align: left; border-right: 1px solid black;">{{ $det['producto'] }}</td>
