    ...
    <table class="table-head table-borderless" style="padding-bottom: 7px" width="100%">
        <tr style="">
            ...
            <th width="30%" style=" text-align: right;">
                ...
                <strong ><FONT FACE="times new roman" style="color: black" SIZE=4>{{'NOTA DE VENTA '}} - {{$id}}</FONT></strong >
                </div>    
                <!-- <div style="font-weight: normal" >
            ...
            <td colspan=4>
                <div class="container2" style="padding-top: 5px; padding-bottom: 5px; padding-left: 10px; text-align: center; border: 2px solid <?php echo $color1; ?>; border-radius: 5px, 5px">
                    <div id="lateral" class="A" style="width:25%; text-align:left" >    
                        <div style="font-weight: normal">
                            <strong ><FONT FACE="times new roman" style=" color: <?php echo $color5; ?>" SIZE=2>{{__('CLIENTE: ')}}</FONT></strong>
                        </div>
                        <div style="font-weight: normal">
                    ...
                    <div id="lateral" class="A" style="width:25%; text-align:left">    
                        <div style="font-weight: normal">
                            <FONT FACE="times new roman" style=" color: <?php echo $color5; ?>" SIZE=2>{{ $cliente }}</FONT>
                        </div>
                        <div style="font-weight: normal">
        ...
        <div class="col-lg-7 col-md-7" style=" color: black">
            ...
            <table class="table" style="">
                ...
                <tbody  style="border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black">
                    ...
                    <tr style="border-top: 1px solid black">
                        <td style="text-align: center; border-right: 1px solid black;">{{ $numero }}</td>
                        <td style="text-align: center; border-right: 1px solid black;">{{ 'PAQUETES' }}</td>
                        <td style="text-align: left; border-right: 1px solid black;">{{ $det2['articulo'] }}</td>
                        {{-- <td style="text-align: center; border-right: 1px solid black;"><strong ><FONT FACE="times new roman" style=" color: black" SIZE=2>{{ $det['tienda']}}</FONT><strong ></td> --}}
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det2['costo_venta']}}</td>
                        <td style="text-align: right; border-right: 1px solid black; background-color:<?php echo $color6; ?>">{{ $det2['cantidad']}}</td>
                        <td style="text-align: left; border-right: 1px solid black; text-align: center; background-color:<?php echo $color6; ?>">{{ $det2['sub_total'] }}</td>
                    </tr>
                    @php
                    $numero++;
                @endphp
