<table>
    ...
    <thead>
        ...
        <tr>
            ...
            <th style="text-align: center; margin: auto; background-color: #68D3AB; border: #000 solid 1px; width: 150px;"><b>Cargo</b></th>
        </tr>                
    </thead>
    <tbody>                        
        @php
        ...
        @foreach($detalles as $detalle)
            <tr>
                ...
                <td style="text-align: center; border: #000 solid 1px;">{{$detalle['cargo']}}</td>
            </tr>
            @php
            $numero++;
            @endphp
