<table>
    ...
    <thead>
        ...
        <tr>
            ...
            <th style="text-align: center; background-color: #68D3AB; border: #000 solid 1px; width: 150px;"><b>Nombre</b></th>
            <th style="text-align: center; background-color: #68D3AB; border: #000 solid 1px; width: 150px;"><b>Nit</b></th>
            <th style="text-align: center; background-color: #68D3AB; border: #000 solid 1px; width: 150px;"><b>Contacto</b></th>
            <th style="text-align: center; margin: auto; background-color: #68D3AB; border: #000 solid 1px; width: 150px;"><b>Dirección</b></th>
            <th style="text-align: center; margin: auto; background-color: #68D3AB; border: #000 solid 1px; width: 150px;"><b>Teléfono</b></th>
            <th style="text-align: center; margin: auto; background-color: #68D3AB; border: #000 solid 1px; width: 150px;"><b>Descripción</b></th>
        </tr>                
    </thead>
    <tbody>                        
        @php
        ...
        @foreach($detalles as $detalle)
            <tr>
                ...
                <td style="text-align: center;border: #000 solid 1px;">{{$detalle['nit']}}</td>  
                <td style="text-align: center; border: #000 solid 1px;">{{$detalle['contacto']}}</td>
