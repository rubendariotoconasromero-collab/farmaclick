<table>
    ...
    <thead>
        ...
        <tr>
            <th></th>
            <td colspan="9" style="text-align: left"><b></b> &nbsp; <span style="font-weight: bold"></span></td>
            <th></th>
        ...
        <tr>
            <th></th>
            <th colspan="9" style="text-align: left;"><b></b> &nbsp; </th>
            <th></th>
    ...
    <tbody>
        ...
        @foreach($detalles as $detalle)
            <tr>
                ...
                <td style="text-align: center;border: #000 solid 1px;">{{ $detalle['tp_efectivo'] != '0' ? $detalle['tp_efectivo'] : '0.00'  }}</td>
                <td style="text-align: center;border: #000 solid 1px;">{{ $detalle['tp_deposito'] != '0' ? $detalle['tp_deposito'] : '0.00' }}</td>
                <td style="text-align: center;border: #000 solid 1px;">{{ $detalle['tp_transferencia'] != '0' ? $detalle['tp_transferencia'] : '0.00' }}</td>
                <td style="text-align: center;border: #000 solid 1px;">{{ $detalle['tp_qr'] != '0' ? $detalle['tp_qr'] : '0.00' }}</td>
