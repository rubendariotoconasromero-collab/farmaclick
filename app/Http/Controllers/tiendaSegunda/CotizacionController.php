...
namespace App\Http\Controllers\tiendaSegunda;
...
class CotizacionController extends BitacoraController
{
    ...
    public function detalleCotizacion(Request $request){
        ...
        'categoria.nombre as categoria','detalle_cotizacion.cantidad','detalle_cotizacion.sub_total','tienda_articulo.stock','detalle_cotizacion.tiempo_entrega','tienda.nombre as tienda','tienda.id as id_tienda','tienda_articulo.id as id_tienda_articulo','tienda_articulo.id_articulo')
    ...
    //     $cotizacion= Proforma::join('users','cotizacion.id_usuario','=','users.id')
    //     ->join('cliente','cotizacion.id_cliente','=','cliente.id')
    //     ->join('personal','cliente.id_ejecutivo_venta','=','personal.id')
    //     ->join('tipo_pago','cotizacion.id_tipo_pago','=','tipo_pago.id')
    //     ->select('cotizacion.id','cotizacion.codigo_proforma','cotizacion.fecha','cotizacion.fecha_venci','cotizacion.con_factura','cotizacion.dias_credito'
    ...
    //     'cotizacion.total','cotizacion.estado','users.name as usuario','cliente.nombre as cliente','cliente.nombre_contrato as contacto'
    //     ,'cliente.direccion as direccion','cliente.telefono_celular as telefono','cliente.correo as correo','cliente.ciudad as ciudad','cliente.nit as nit'
    //     ,'users.id as id_usuario','cliente.id as id_cliente','personal.nombre as personal')
    //     ->where('cotizacion.id',$id)
    //     ->orderBy('cotizacion.id','desc')->get();

    //     $detalle_cotizacion= detalleproforma::join('producto','detalle_cotizacion.id_producto','=','producto.id')
    //     ->join('medida','producto.id_medida','=','medida.id')
    //     ->select('detalle_cotizacion.pu','detalle_cotizacion.id_proforma','detalle_cotizacion.tiempo_entrega','detalle_cotizacion.cantidad','detalle_cotizacion.sub_total','producto.nombre as producto'
    //     ,'producto.id as codigo_producto','producto.foto as foto','producto.modelo as modelo','producto.marca as marca','producto.id as codigo','producto.observacion as observacion',
    //     'producto.cod_producto as cod_producto','medida.nombre as medida'
    //     ,'detalle_cotizacion.id_producto','detalle_cotizacion.descuento')
    //     ->where('detalle_cotizacion.id_proforma','=',$id)
    //     ->get();
    ...
    //     $codigo_proforma=$cotizacion[0]->codigo_proforma;
    ...
    //     // $forma_pago=$cotizacion[0]->forma_pago;
