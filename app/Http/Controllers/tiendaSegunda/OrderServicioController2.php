...
class OrderServicioController2 extends BitacoraController
{
    public function index(Request $request){
        ...
        if($buscar==''){
            ...
            ->where('orden_servicio.id_tienda','=',3)
    ...
    public function guardar(Request $request){
        try{
                ...
                $datos = [
                    ...
                    'transaccion' => 'guardar servicio tienda 2',
                ];
    ...
    public function modificar(Request $request){
        ...
        $datos = [
            ...
            'codigo_tabla' => $servicio->id,
            'transaccion' => 'modificar servicio tienda 2',
        ];
        $this->guardarBitacora($datos);
    }    
    ...
    public function detalleOrdenServicio(Request $request){
        ...
        'articulo.costo_unitario','articulo.costo_mayorista','articulo.costo_preferencial','articulo.nombre as articulo','articulo.marca',
    ...
    public function anular(Request $request){
        ...
        $datos = [
            ...
            'transaccion' => 'Anular Servicio Tienda 2',
        ];
        $this->guardarBitacora($datos); 
