...
class OrderServicioController3 extends BitacoraController
{
    public function index(Request $request){
        ...
        if($buscar==''){
            ...
            ->where('orden_servicio.id_tienda','=',4)
    ...
    public function modificar(Request $request){
        ...
        $datos = [
            ...
            'codigo_tabla' => $servicio->id,
            'transaccion' => 'modificar servicio tienda 3',
        ];
        $this->guardarBitacora($datos);
    }    
    ...
    public function anular(Request $request){
        ...
        $datos = [
            ...
            'transaccion' => 'Anular Servicio Tienda 3',
        ];
        $this->guardarBitacora($datos); 
